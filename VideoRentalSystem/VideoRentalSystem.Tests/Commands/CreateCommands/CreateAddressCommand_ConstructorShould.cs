...
{
    [TestFixture]
    public class CreateAddressCommand_ConstructorShould
    {
        [Test]
        public void ThrowArgumentNullException_WhenInvalidDbParameterIsPassed()
        {
            ...
            //Act & Arrange
            Assert.Throws<ArgumentNullException>(() => new CreateAddressCommand(null, factoryMock.Object));
        }
        ...
        public void ThrowArgumentNullException_WhenInvalidFactoryParameterIsPassed()
        {
            ...
            //Act & Arrange
            Assert.Throws<ArgumentNullException>(() => new CreateAddressCommand(dbMock.Object, null));
        }
        ...
        public void NotThrow_WhenInvalidFactoryParameterIsPassed()
        {
            ...
            //Act & Arrange
            Assert.DoesNotThrow(() => new CreateAddressCommand(dbMock.Object, factoryMock.Object));
        }
    }
}
